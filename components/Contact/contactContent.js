...
export default function ContactContent() {
  ...
  function updateClipboard(e) {
    navigator.clipboard.writeText("vaishak.kaippanchery@gmail.com").then(
      function () {
    ...
    <>
      <div className={styles.row}>
        <div className={styles.stack}>
          ...
          <p className={styles.subText}>vaishak.kaippanchery@gmail.com</p>
        </div>

        <div className={styles.buttonPair}>
          <a
            className={util.button + " " + styles.rightBorder}
            href="mailto:vaishak.kaippanchery@gmail.com"
            target="_blank"
      ...
      <div className={styles.row}>
        ...
        <a
          href="https://cal.com/kvaishak/15min"
          target="_blank"
          rel="noopener noreferrer"
          className={
